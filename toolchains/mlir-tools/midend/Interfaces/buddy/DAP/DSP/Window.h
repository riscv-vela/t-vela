...
#ifndef FRONTEND_INTERFACES_npu_DAP_DSP_WINDOW
#define FRONTEND_INTERFACES_npu_DAP_DSP_WINDOW

#include "npu/Core/Container.h"
#include "npu/DAP/DSP/Math.h"
...
#endif // FRONTEND_INTERFACES_npu_DAP_DSP_WINDOW
