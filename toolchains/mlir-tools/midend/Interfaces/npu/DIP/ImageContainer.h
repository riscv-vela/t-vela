...
#ifndef FRONTEND_INTERFACES_npu_DIP_IMAGECONTAINER
#define FRONTEND_INTERFACES_npu_DIP_IMAGECONTAINER

#include "npu/Core/Container.h"
#include "npu/DIP/imgcodecs/replenishment.h"
#include <cassert>

#ifdef npu_ENABLE_OPENCV
...
#endif // FRONTEND_INTERFACES_npu_DIP_IMAGECONTAINER
